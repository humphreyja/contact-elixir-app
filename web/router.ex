defmodule Contact.Router do
  ...
  pipeline :app_layout do
    plug :put_layout, {Contact.App.LayoutView, :app}
  end

  scope "/app", Contact do
    pipe_through [:browser, :browser_auth, :impersonation_browser_auth, :app_layout]
    get "/", App.ContactsController, :index
    get "/user-settings", App.UserController, :edit
  end

  # This scope is the main authentication area for Ueberauth
  scope "/auth", Contact do
  ...
  scope "/admin", Contact.Admin, as: :admin do
