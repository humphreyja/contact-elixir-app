defmodule Contact.Admin.SessionController do
  @moduledoc """
  ...
  """
  use Contact.Web, :admin_controller
  ...
  # We've aliased Guardian.Plug.EnsureAuthenticated in our Contact.Web.admin_controller macro
